...
python cell_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_hvg.h5ad' --vae_path 'output/checkpoint/AE/zeng23_hvg/model_seed=0_step=150000.pt' --model_name 'zeng23_hvg' --save_dir 'output/checkpoint/backbone' --lr_anneal_steps 800000 |& tee -a train_backbone.log
# python cell_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_full.h5ad' --vae_path 'output/checkpoint/AE/zeng23_full/model_seed=0_step=150000.pt' --model_name 'zeng23_full' --save_dir 'output/checkpoint/backbone' --lr_anneal_steps 800000 |& tee -a train_backbone.log
