...
python cell_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_hvg.h5ad' --train_split_only --vae_path 'output/checkpoint/AE/zeng23_hvg/model_seed=0_step=150000.pt' --model_name 'zeng23_hvg' --save_dir 'output/checkpoint/backbone' --lr_anneal_steps 800000 --device_ids cuda:0 |& tee -a train_backbone_hvg.log
# python cell_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_full.h5ad' --train_split_only --vae_path 'output/checkpoint/AE/zeng23_full/model_seed=0_step=150000.pt' --model_name 'zeng23_full' --save_dir 'output/checkpoint/backbone' --lr_anneal_steps 800000 --device_ids cuda:0 |& tee -a train_backbone_full.log

mkdir output/checkpoint/classifier
python classifier_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_hvg.h5ad' --train_split_only --model_path "output/checkpoint/classifier/zeng23_hvg" --iterations 400000 --vae_path 'output/checkpoint/AE/zeng23_hvg/model_seed=0_step=150000.pt' --device_ids cuda:0 |& tee -a train_classifier_hvg.log
# python classifier_train.py --data_dir '../diffusion-scratch/data/processed/zeng23/zeng23_full.h5ad' --train_split_only --model_path "output/checkpoint/classifier/zeng23_full" --iterations 400000 --vae_path 'output/checkpoint/AE/zeng23_full/model_seed=0_step=150000.pt' --device_ids cuda:0 |& tee -a train_classifier_full.log
